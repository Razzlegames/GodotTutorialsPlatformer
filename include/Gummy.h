...
inline void Gummy::changeAnimationFrame(int frame)
{
...
inline void Gummy::playJumpSound()
{
...
inline void Gummy::playImpactSound()
{
...
inline void Gummy::playImpactSound(unsigned int volume)
{
    ...
    //    effect frequency etc)
    kramPlayExt(samples[14], 1, 0,
            S3M_SAMPLE_FREQUENCY*2,32+3*volume,0);
