...
///     Gummy characters 
int BallGreen::pallet_tile_mem_loaded = 0;

/// GFX memory index (how far into GFX memory are the 
/// tiles for this character: if using same tile 
/// set for all gummys)
int BallGreen::gfx_memory_index = 0;

BallGreen::BallGreen(int pallet_number2): Ball(pallet_number2)
{
...
void BallGreen::init(u8 pallet_number, 
        ...
        int velocity_vector_x, int velocity_vector_y)
{
    ...
    // Set up Collision Box (assume middle of box is 
